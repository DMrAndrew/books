...
namespace Books\Book\Classes\Epub;
...
class TPEpubCreator
{
    ...
    private function CreateFolders()
    {
        ...
        \Storage::createDirectory($this->uuid);
        ...
        \Storage::createDirectory($this->uuid . '/META-INF');
        \Storage::createDirectory($this->uuid . '/OEBPS');
        \Storage::createDirectory($this->uuid . '/OEBPS/images');
    ...
    private function CreateZip()
    {
        ...
        \Storage::deleteDirectory($this->uuid.'/META-INF');
        \Storage::deleteDirectory($this->uuid.'/OEBPS/images');
        \Storage::deleteDirectory($this->uuid.'/OEBPS');
        \Storage::deleteDirectory($this->uuid);
    }
}
