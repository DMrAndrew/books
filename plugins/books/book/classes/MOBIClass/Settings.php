...
class Settings
{
    ...
    public function __construct($additionalSettings = array())
    {
        ...
        $this->values = array(
            ...
            'nextRecordListID' => 0,
            'recordAttributes' => 0,
            'compression' => ConstantsEnum::NO_COMPRESSION->value(),
            'recordSize' => ConstantsEnum::RECORD_SIZE->value(),
            'encryptionType' => ConstantsEnum::NO_ENCRYPTION->value(),
            'mobiIdentifier' => 'MOBI',
            'mobiHeaderLength' => 0xe8,
            'mobiType' => ConstantsEnum::MOBIPOCKET_BOOK->value(),
            'textEncoding' => ConstantsEnum::UTF8->value(),
            'uniqueID' => rand(),
            'fileVersion' => 6,
            'locale' => 0x09,
            'inputLanguage' => 0,
