...
return new class extends Migration
{
    ...
    public function up()
    {
         ...
         * #############################
         */
        echo 'Profiles table' . PHP_EOL;
        $originTable = 'books_profile_profiles';
        $originKey = 'user_id';
        $foreignTable = 'users';
        $foreignKey = 'id';
        ...
        /**
         * #############################
         * Operation history to user
         * #############################
         */
        echo 'Operation history table' . PHP_EOL;
        $originTable = 'books_profile_operation_histories';
        $originKey = 'user_id';
        $foreignTable = 'users';
        $foreignKey = 'id';
        ...
        /**
         * #############################
         * Subscriber to profile
         * #############################
         */
        echo 'Subscribers table' . PHP_EOL;
        $originTable = 'books_profile_subscribers';
    ...
    public function down()
    {
        $foreigns = [
            ...
            ['books_profile_operation_histories', 'user_id'],
            ['books_profile_subscribers', 'profile_id'],
            ['books_profile_subscribers', 'subscriber_id'],
        ];
