...
return new class extends Migration
{
    ...
    public function up()
    {
        /**
         * #############################
         * WithdrawalData to user
         * #############################
         */
        echo 'WithdrawalData table' . PHP_EOL;
        $originTable = 'books_withdrawal_data';
        $originKey = 'user_id';
        $foreignTable = 'users';
        $foreignKey = 'id';
         ...
         * #############################
         */
        echo 'Withdrawal table' . PHP_EOL;
        $originTable = 'books_withdrawal_withdrawals';
        $originKey = 'user_id';
        $foreignTable = 'users';
        $foreignKey = 'id';
    ...
    {
        $foreigns = [
            ['books_withdrawal_data', 'user_id'],
            ['books_withdrawal_withdrawals', 'user_id'],
        ];
