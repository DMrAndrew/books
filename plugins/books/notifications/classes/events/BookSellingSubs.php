...
class BookSellingSubs extends BaseEvent
{
    public string $eventName = 'Подписка';

    public string $eventDescription = 'На книгу в статусе "В работе" начат старт продаж в статусе книги "В работе".';
