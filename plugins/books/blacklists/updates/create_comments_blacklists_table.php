...
/**
 * CreateCommentsBlacklistsTable Migration
 *
...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('books_blacklists_comments_blacklists', function(Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('books_blacklists_comments_blacklists');
    }
};
